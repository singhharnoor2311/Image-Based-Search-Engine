...
def faces(filename):
    ...
    for counter,face in enumerate(faces):
        ...
        new_path = f'images/extracted_images\multi2{counter}'
...
image = 'images\Train/amitabh(2).jpg'
#for image in glob.glob('images\Test\depositphotos_29133839-stock-photo-group-of-girls-chilling-on.jpg'):
faces(image)